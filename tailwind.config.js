  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        codeDefault: withOpacity('--color-code-default'),
        codeKeyword: withOpacity('--color-code-keyword'),
        codeLineNumber: withOpacity('--color-code-line-number'),
        codeComment: withOpacity('--color-code-comment'),
        codePunctuation: withOpacity('--color-code-punctuation'),
        codeFunction: withOpacity('--color-code-function'),
        codeProperty: withOpacity('--color-code-property'),
        codeOperator: withOpacity('--color-code-operator'),
        modal: {
