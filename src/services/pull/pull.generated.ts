...
export type PullQueryVariables = Types.Exact<{
  owner: Types.Scalars['String']
  repo: Types.Scalars['String']
  pullId: Types.Scalars['Int']
}>
...
export const usePullQuery = <TData = PullQuery, TError = unknown>(
  ...
  useQuery<PullQuery, TError, TData>(
    ['Pull', variables],
    useFetchData<PullQuery, PullQueryVariables>(PullDocument).bind(
      null,
      variables
    ),
    options
  )
export const useInfinitePullQuery = <TData = PullQuery, TError = unknown>(
  variables: PullQueryVariables,
  options?: UseInfiniteQueryOptions<PullQuery, TError, TData>
) => {
  const query = useFetchData<PullQuery, PullQueryVariables>(PullDocument)
  return useInfiniteQuery<PullQuery, TError, TData>(
    ['Pull.infinite', variables],
