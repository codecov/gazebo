...
describe('useStaticNavLinks', () => {
  ...
  describe('cloud', () => {
    ...
    describe.each`
      ...
      ${links.codecovGithubApp}              | ${'https://github.com/apps/sun-codecov-self-hosted'}
      ${links.codecovGithubAppSelectTarget}  | ${'https://github.com/apps/sun-codecov-self-hosted/installations/select_target'}
