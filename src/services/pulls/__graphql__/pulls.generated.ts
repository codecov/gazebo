...
export type Comparison = {
  ...
  baseTotals?: Maybe<CoverageTotals>
  changeWithParent?: Maybe<Scalars['Float']>
  error?: Maybe<ComparisonError>
  fileComparisons?: Maybe<Array<FileComparison>>
  headTotals?: Maybe<CoverageTotals>
...
export type CoverageTotals = {
  ...
  percentCovered?: Maybe<Scalars['Float']>
}
...
export type FileComparison = {
  __typename?: 'FileComparison'
  baseName?: Maybe<Scalars['String']>
  baseTotals?: Maybe<CoverageTotals>
  hasChanges: Scalars['Boolean']
  hasDiff: Scalars['Boolean']
  headName?: Maybe<Scalars['String']>
  headTotals?: Maybe<CoverageTotals>
  isNewFile: Scalars['Boolean']
  segments: Array<SegmentComparison>
}
...
export type LineComparison = {
  __typename?: 'LineComparison'
  baseCoverage?: Maybe<CoverageLine>
  baseNumber?: Maybe<Scalars['String']>
  content?: Maybe<Scalars['String']>
  headCoverage?: Maybe<CoverageLine>
  headNumber?: Maybe<Scalars['String']>
}
...
export type SegmentComparison = {
  __typename?: 'SegmentComparison'
  header?: Maybe<Scalars['String']>
  lines: Array<LineComparison>
}
...
export type GetPullsQueryVariables = Types.Exact<{
  owner: Types.Scalars['String']
  repo: Types.Scalars['String']
  orderingDirection?: Types.InputMaybe<Types.OrderingDirection>
  filters?: Types.InputMaybe<Types.PullsSetFilters>
  after?: Types.InputMaybe<Types.Scalars['String']>
}>

export type GetPullsQuery = {
  __typename?: 'Query'
  owner?: {
    __typename?: 'Owner'
    repository?: {
      ...
      pulls?: {
        ...
        edges: Array<{
          ...
          node: {
            ...
            pullId?: number | null
            title?: string | null
            state?: Types.PullRequestState | null
...
export type PullFragmentFragment = {
  __typename?: 'Pull'
  pullId?: number | null
  title?: string | null
  state?: Types.PullRequestState | null
  ...
  head?: {
    __typename?: 'Commit'
    totals?: { __typename?: 'CoverageTotals'; coverage?: number | null } | null
  } | null
  compareWithBase?: {
    __typename?: 'Comparison'
    changeWithParent?: number | null
...
export const PullFragmentFragmentDoc = `
...
export const GetPullsDocument = `
  ...
  owner(username: $owner) {
    ...
    ${PullFragmentFragmentDoc}`
export const useGetPullsQuery = <TData = GetPullsQuery, TError = unknown>(
  variables: GetPullsQueryVariables,
  options?: UseQueryOptions<GetPullsQuery, TError, TData>
) =>
  useQuery<GetPullsQuery, TError, TData>(
    ['GetPulls', variables],
    useFetchData<GetPullsQuery, GetPullsQueryVariables>(GetPullsDocument).bind(
      null,
      variables
    ),
    options
  )
export const useInfiniteGetPullsQuery = <
  TData = GetPullsQuery,
  TError = unknown
>(
  variables: GetPullsQueryVariables,
  options?: UseInfiniteQueryOptions<GetPullsQuery, TError, TData>
) => {
  const query = useFetchData<GetPullsQuery, GetPullsQueryVariables>(
    GetPullsDocument
  )
  return useInfiniteQuery<GetPullsQuery, TError, TData>(
    ['GetPulls.infinite', variables],
