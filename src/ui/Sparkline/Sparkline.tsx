      ...
      <tbody className="flex flex-1 flex-row">
        {data.map(({ start, end, mode, value }, i) => {
          ...
          return (
            ...
            >
              <td
                className="line absolute inset-0 flex flex-1 p-0 before:absolute before:inset-0 before:bg-ds-chartAreaStroke before:content-[''] after:absolute after:inset-0 after:bg-ds-blue-darker/10 after:content-['']"
