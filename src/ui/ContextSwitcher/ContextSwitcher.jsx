...
function ContextSwitcher({
  ...
  return (
    <div id="context-switcher" className="relative text-sm" ref={wrapperRef}>
      ...
      <ul
        className={cs(
          'absolute z-10 max-h-64 w-full overflow-y-auto rounded-md bg-ds-background shadow-md ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-ds-background-dark dark:shadow-lg dark:ring-1 dark:ring-ds-gray-tertiary',
          { hidden: !toggle }
        )}
        tabIndex="-1"
        role="listbox"
