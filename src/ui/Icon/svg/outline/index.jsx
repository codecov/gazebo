...
import exclamationTriangle from './exclamation-triangle.svg?react'
...
export { arrowDown, arrowUp, ban, bookOpen, checkCircle, check, chevronDown, chevronLeft, chevronRight, chevronUp, clipboardCopy, cog, database, documentText, document, download, exclamationCircle, exclamationTriangle, exclamation, externalLink, eyeOff, eye, flag, folder, globeAlt, home, informationCircle, lightBulb, lockClosed, moon, noSymbol, plusCircle, printer, questionMarkCircle, refresh, search, speakerphone, sun, trash, xCircle, x }