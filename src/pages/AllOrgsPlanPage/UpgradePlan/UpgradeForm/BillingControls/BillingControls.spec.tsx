...
describe('BillingControls', () => {
  ...
  describe('disableInputs is set to true', () => {
    it('disables annual button', async () => {
    ...
    it('disables monthly button', async () => {
      const { mockSetValue } = setup()
      ...
      const monthlyBtn = await screen.findByRole('button', { name: 'Monthly' })
