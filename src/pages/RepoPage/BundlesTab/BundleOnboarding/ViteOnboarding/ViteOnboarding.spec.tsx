      ...
      describe('npm', () => {
        ...
        describe('user clicks copy button', () => {
          it('sends metric to sentry', async () => {
            ...
            await waitFor(() =>
              expect(Sentry.metrics.increment).toHaveBeenCalledWith(
                'bundles_tab.onboarding.vite.copied.install_command',
                1,
  ...
  describe('step 2', () => {
    ...
    describe('user clicks copy button', () => {
      it('sends metric to sentry', async () => {
        ...
        await waitFor(() =>
          expect(Sentry.metrics.increment).toHaveBeenCalledWith(
            'bundles_tab.onboarding.vite.copied.token',
            1,
            undefined
          )
        )
  ...
  describe('step 3', () => {
    ...
    describe('user clicks copy button', () => {
      it('sends metric to sentry', async () => {
        ...
        await waitFor(() =>
          expect(Sentry.metrics.increment).toHaveBeenCalledWith(
            'bundles_tab.onboarding.vite.copied.config',
            1,
            undefined
          )
        )
  ...
  describe('step 4', () => {
    ...
    describe('user clicks copy button', () => {
      it('sends metric to sentry', async () => {
        ...
        await waitFor(() =>
          expect(Sentry.metrics.increment).toHaveBeenCalledWith(
            'bundles_tab.onboarding.vite.copied.commit',
            1,
            undefined
          )
        )
      ...
      describe('npm', () => {
        ...
        describe('user clicks copy button', () => {
          it('sends metric to sentry', async () => {
            ...
            await waitFor(() =>
              expect(Sentry.metrics.increment).toHaveBeenCalledWith(
                'bundles_tab.onboarding.vite.copied.build_command',
                1,
                { tags: { package_manager: 'npm' } }
              )
            )
