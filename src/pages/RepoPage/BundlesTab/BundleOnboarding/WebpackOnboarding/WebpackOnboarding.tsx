  ...
  return (
    <Card>
      ...
      <Card.Content className="flex flex-col gap-4">
        ...
        <CodeSnippet clipboard={npmInstall} data-testid="webpack-npm-install">
          {npmInstall}
        </CodeSnippet>
        <CodeSnippet clipboard={yarnInstall} data-testid="webpack-yarn-install">
          {yarnInstall}
        </CodeSnippet>
        <CodeSnippet clipboard={pnpmInstall} data-testid="webpack-pnpm-install">
          {pnpmInstall}
        </CodeSnippet>
      </Card.Content>
    </Card>
  ...
  return (
    <Card>
      ...
      <Card.Content className="flex flex-col gap-4">
        ...
        <CodeSnippet clipboard={npmBuild} data-testid="webpack-npm-build">
          {npmBuild}
        </CodeSnippet>
        <CodeSnippet clipboard={yarnBuild} data-testid="webpack-yarn-build">
          {yarnBuild}
        </CodeSnippet>
        <CodeSnippet clipboard={pnpmBuild} data-testid="webpack-pnpm-build">
          {pnpmBuild}
        </CodeSnippet>
      </Card.Content>
    </Card>
