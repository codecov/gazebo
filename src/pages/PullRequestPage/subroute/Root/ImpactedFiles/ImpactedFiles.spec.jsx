...
describe('ImpactedFiles', () => {
  ...
  describe('prefetching file diff', () => {
    beforeEach(() => {
      setup()
    })

    describe('when the code diff is not expanded', () => {
      it('primes the react query cache', async () => {
        render(<ImpactedFiles />, { wrapper: wrapper() })
    ...
    describe('when the code diff is expanded', () => {
      it('does not prime the react query cache', async () => {
        render(<ImpactedFiles />, { wrapper: wrapper() })
        ...
        // need to clear the cache to make sure it remains undefined
        await waitFor(() => queryClient.clear())
