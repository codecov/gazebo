...
export default function TermsOfService() {
  ...
  return (
    <div className="mx-auto w-full max-w-[30rem] text-sm text-ds-gray-octonary">
      <h1 className="py-4 text-2xl font-semibold">Welcome to Codecov</h1>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-4 border-y border-ds-gray-tertiary py-4">
          ...
          <p className="mb-4 text-xs text-ds-gray-quaternary">
            Don&apos;t see your org?{' '}
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              and the{' '}
              <A href="https://about.codecov.io/privacy" hook="privacy policy">
                privacy policy
              </A>{' '}
              required
            </label>
